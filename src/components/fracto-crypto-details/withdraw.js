...
import { setCryptoWhitelistPopup } from "../../redux/reducers/user_reducer";

const FractoCryptoWithdraw = ({
  withdrawFund,
  setWithdrawFund,
                ...
                <div className="bg-white mt-3 p-3 current-balance">
                  ...
                  <div>
                    <div className="cb-balance">
                      ...
                      {parseFloat(withdrawFund?.balance).toFixed(2)}
                    </div>
                  </div>
                </div>
                                ...
                                <>
                                  <div className="pre-btn">
                                    <p
                                      ...
                                      onClick={() => {
                                        dispatch(
                                          setCryptoWhitelistPopup(network)
                                        );
...
export default FractoCryptoWithdraw;
