                      ...
                      {payMethod === "crypto" && (
                        <>
                          ...
                          <div className="mt-3 mb-3">
                            ...
                            />
                            <div class="mt-4 mb-3 p-3 rounded-3 border">
                              <p class="card-info">
                                Note: Please only provide addresses that support
                                Polygon ERC-20. Any other chain/standard address
                                will result in the loss of your crypto, and we
                                will not be held responsible. Additionally, do
                                not use any exchange addresses. After burning,
                                the same wrapped crypto will be transferred to
