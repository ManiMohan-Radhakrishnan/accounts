                  ...
                  <>
                    ...
                    {/* <Nav.Link className="css-5cmxo2 me-3" id="drop_outer">
                      <div
                        ...
                        role="button"
                        onClick={() =>
                          navigate("/accounts/refer-earn-instruction")
                        }
                      >
                        <span className="beta-container">Refer-Earn</span>
                      </div>
                      ...
                      >
                        ...
                        {isMin ? (
                          <>
                            ...
                            <Dropdown.Item
                              as="button"
                              onClick={() => navigate("/accounts/mynft")}
                            >
                              My NFTs
                            </Dropdown.Item>
                            {showTransferNftMenu && (
                              <Dropdown.Item
                                as="button"
                                onClick={() =>
                                  navigate("/accounts/transfer-nft")
                                }
                              >
                                Transfer NFT
                              </Dropdown.Item>
                            ...
                            <Dropdown.Item
                              as="button"
                              onClick={() => navigate("/accounts/rented-nft")}
                            >
                              My Borrowed NFTs
                            ...
                            <Dropdown.Item
                              as="button"
                              onClick={() => navigate("/accounts/my-cards")}
                            >
                              My Cards
                            </Dropdown.Item>
                            <Dropdown.Item
                              as="button"
                              onClick={() => navigate("/accounts/referral")}
                            >
                              Referral
                            </Dropdown.Item>
                            <Dropdown.Item
                              as="button"
                              onClick={() => navigate("/accounts/wallet")}
                            >
                              GuardianLink Wallet
                            </Dropdown.Item>
                            <Dropdown.Item
                              as="button"
                              onClick={() => navigate("/accounts/my-orders")}
                            >
                              My Orders
                            </Dropdown.Item>
                            <Dropdown.Item
                              as="button"
                              onClick={() => navigate("/accounts/myinvoice")}
                            >
                              My Invoices
                            </Dropdown.Item>
                            <Dropdown.Item
                              as="button"
                              onClick={() => navigate("/accounts/bid-activity")}
                            >
                              My Bids
                            </Dropdown.Item>
                            <Dropdown.Item
                              as="button"
                              onClick={() => navigate("/accounts/pre-orders")}
                            >
                              Pre Book
                            </Dropdown.Item>
                            <Dropdown.Item
                              as="button"
                              onClick={() => navigate("/accounts/game-pass")}
                            >
                              Game Pass
                            </Dropdown.Item>
                            <Dropdown.Item
                              as="button"
                              onClick={() => navigate("/accounts/limit-orders")}
                            >
                              Limit Orders
                              {/* <i className="newbadge blink_me">new</i> */}
                            </Dropdown.Item>
                            <Dropdown.Item
                              as="button"
                              onClick={() => navigate("/accounts/spin-wheel")}
                            >
                              Spin the Wheel
                            </Dropdown.Item>
                            <Dropdown.Item
                            ...
                            <Dropdown.Item
                              as="button"
                              onClick={() => navigate("/accounts/whitelist")}
                            >
                              Whitelist Payment
                            </Dropdown.Item>
                            <Dropdown.Divider />
                          ...
                          <>
                            ...
                            <Dropdown.Item
                              as="button"
                              onClick={() =>
                                navigate("/accounts/user-activity")
                              }
                            >
                              Activity
                            </Dropdown.Item>
