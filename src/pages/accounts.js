...
import UserManagementUserProfile from "../components/accounts/user-management-profile/index";
...
import BurnLogs from "../components/accounts/burn-log";
  ...
  return (
    <>
      <DashboardWrapper hideHeader={hideMenus}>
        ...
        {currentPage === "burn-history" && <BurnLogs />}
