...
const NavigateComponent = lazy(() => import("./pages/navigate"));
        ...
        <Router basename="/">
          <Suspense fallback={PreLoader}>
            <Routes>
              ...
              />
              <Route exact path="/signup/:source?" element={<Register />} />
...
const PrivateRoute = ({ children }) => {
  ...
  return (
    ...
    //   <Route
    //     {...rest}
    //     element={user.login ? <Element /> : <Navigate to="/signin" replace />}
    //   />
    // </Routes>

    user?.login ? children : <Navigate to="/signin" replace />
  );
};
...
const AutoLoginRoute = ({ children }) => {
  ...
  return !isUserLoggedIn ? <PreLoader /> : children;
};
